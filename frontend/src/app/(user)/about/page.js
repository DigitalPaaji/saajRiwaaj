...
const returnsPolicyData = [
  {
    heading: "About Saaj Riwaaj",
    para: "Saaj Riwaaj was founded in Patiala with a dream to bring timeless elegance and artistry of traditional jewelry into the modern world. With deep roots in Punjabi culture and an eye on global trends, our journey began with a passion to create designs that are not just ornaments but an expression of individuality and heritage. \n\nToday, Saaj Riwaaj has grown into a recognized jewelry brand with a dedicated team of designers, artisans, and creative professionals who carefully craft every piece to reflect beauty, grace, and authenticity. From karigars shaping intricate details to our stylists and marketers sharing them with the world, every member of our team contributes to making Saaj Riwaaj a symbol of trust and style.\n\nWe believe every piece of jewelry carries a story—a reflection of culture, love, and celebration. At Saaj Riwaaj, we are here to craft those stories for the modern generation while preserving the elegance of traditions. With a growing presence across India and on social media, Saaj Riwaaj continues to redefine jewelry shopping by offering quality, affordability, and designs that resonate with your soul."
  },
  {
      ...
      <div className="px-4 sm:px-8 lg:px-24 xl:px-60 mx-auto my-16">
        {returnsPolicyData.map((section, index) => (
          <div key={index} className="mb-10">
            ...
            <p className="text-gray-700 leading-7 whitespace-pre-line">{section.para}</p>
          </div>
        ))}
      </div>
    </div>
